...
function CollectionProducts(props) {
    ...
    const { ratingNum, ratingValue, shortDiscription, image, itemSize, name, price, itemNumber } = props
        ...
        <>
           {/* ref={inputRef} */}
            ...
            <div className={classes.counter__section}>
                    <button  onClick={addToCartHandler} className={classes.cart} data-product-id="1">
